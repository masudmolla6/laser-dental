...
import {
  ...
  HeartPulse, Smile, ArrowRight, Clock,
  Phone,
} from "lucide-react";
...
const SERVICES = [
  {
    ...
    duration: "60 min", price: "৳ 4,500", tag: "Most Popular",
    iconBg: "bg-sky-100", iconColor: "text-sky-700",
    tagBg: "bg-sky-100", tagColor: "text-sky-700",
    accent: "bg-sky-700", accentHover: "hover:border-sky-400",
  ...
  },
  {
    ...
    duration: "12–24 months", price: "From ৳ 18,000", tag: "Customized",
    iconBg: "bg-violet-100", iconColor: "text-violet-700",
    tagBg: "bg-violet-100", tagColor: "text-violet-700",
    accent: "bg-violet-700", accentHover: "hover:border-violet-400",
  ...
  },
  {
    ...
    duration: "45 min", price: "৳ 1,800", tag: "Routine Care",
    iconBg: "bg-orange-100", iconColor: "text-orange-700",
    tagBg: "bg-orange-100", tagColor: "text-orange-700",
    accent: "bg-orange-700", accentHover: "hover:border-orange-400",
    barColor: "from-orange-600 to-orange-400",
  ...
  },
  {
    ...
    duration: "60–90 min", price: "৳ 8,000", tag: "Laser Assisted",
    iconBg: "bg-red-100", iconColor: "text-red-700",
    tagBg: "bg-red-100", tagColor: "text-red-700",
    accent: "bg-red-700", accentHover: "hover:border-red-400",
  ...
  },
  {
    ...
    duration: "3–5 sessions", price: "From ৳ 55,000", tag: "Signature",
    iconBg: "bg-amber-100", iconColor: "text-amber-700",
    tagBg: "bg-amber-100", tagColor: "text-amber-700",
    accent: "bg-amber-700", accentHover: "hover:border-amber-400",
  ...
  return (
    <div
      ...
      className={`group relative flex flex-col rounded-3xl overflow-hidden border border-gray-200 bg-white
        ...
        hover:-translate-y-1.5 hover:shadow-xl ${service.borderHover}`}
    >
      {/* Top accent bar */}
      <div className={`h-1 w-full bg-gradient-to-r transition-all duration-300
        ${hovered ? service.barColor : "from-transparent to-transparent"}`}
      />
      ...
      <div className="flex flex-col gap-5 p-7 flex-1">
        ...
        <div className="flex items-start justify-between">
          <div className={`w-14 h-14 rounded-2xl flex items-center justify-center
            transition-transform duration-300 ${service.iconBg} ${service.iconColor}
            ${hovered ? "scale-110 -rotate-6" : ""}`}>
            <Icon size={24} />
          </div>
          <div className="flex flex-col items-end gap-1.5">
            <span className={`text-[10px] font-bold uppercase tracking-widest px-3 py-1 rounded-full
              ${service.tagBg} ${service.tagColor}`}>
              {service.tag}
            </span>
        ...
        <div>
          <h3 className={`text-lg font-bold mb-1.5 leading-snug transition-colors duration-300
            ${hovered ? service.priceColor : "text-gray-900"}`}>
            {service.title}
          </h3>
        ...
        <div className={`overflow-hidden transition-all duration-500
          ...
          <p className={`text-sm text-gray-600 leading-relaxed border-l-2 pl-3
            ${service.iconColor} border-current`}>
            {service.description}
          </p>
        </div>
        ...
        <div className={`flex items-center justify-between pt-5 mt-auto border-t
          ...
          <div className="text-right">
            ...
            <p className={`text-base font-bold ${service.priceColor}`}>{service.price}</p>
          </div>
        </div>
      </div>
      ...
      <div className={`px-7 pb-6 transition-all duration-300
        ...
        <Link to="/appointment"
          className={`w-full py-2.5 rounded-xl text-sm font-semibold text-white
            ...
            ${service.accent} hover:opacity-90`}>
          Book This Service
  ...
  return (
    <section className="min-h-screen bg-slate-50 py-24 px-4 md:px-8">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden -z-10">
        <div className="absolute -top-32 -right-32 w-[500px] h-[500px] rounded-full opacity-[0.06] bg-[radial-gradient(circle,#0369a1,transparent)]" />
        <div className="absolute bottom-0 -left-40 w-[400px] h-[400px] rounded-full opacity-[0.05] bg-[radial-gradient(circle,#7e22ce,transparent)]" />
      </div>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-8 rounded-3xl overflow-hidden relative p-10 md:p-14 text-center bg-gradient-to-br from-sky-900 to-indigo-900">
          <div className="absolute top-0 right-0 w-64 h-64 rounded-full opacity-10 bg-[radial-gradient(circle,#fff,transparent)] translate-x-1/3 -translate-y-1/3" />
          <div className="absolute bottom-0 left-0 w-48 h-48 rounded-full opacity-10 bg-[radial-gradient(circle,#7e22ce,transparent)] -translate-x-1/3 translate-y-1/3" />
