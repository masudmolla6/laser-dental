...
const adminLinks = [
  { name: "Admin Home",     path: "/dashboard/adminHome",     Icon: LayoutDashboard, iconBg: "bg-sky-500/20",    iconColor: "text-sky-400"    },
  { name: "Control Panel",  path: "/dashboard/controlPanel",  Icon: Settings,        iconBg: "bg-violet-500/20", iconColor: "text-violet-400" },
  { name: "Add Banner",     path: "/dashboard/addBanner",     Icon: ImagePlus,       iconBg: "bg-emerald-500/20",iconColor: "text-emerald-400"},
  { name: "Manage Banners", path: "/dashboard/manageBanners", Icon: Images,          iconBg: "bg-amber-500/20",  iconColor: "text-amber-400"  },
  { name: "Add Picture",    path: "/dashboard/addPicture",    Icon: Image,           iconBg: "bg-pink-500/20",   iconColor: "text-pink-400"   },
  { name: "Manage Gallery", path: "/dashboard/manageGallery", Icon: GalleryVertical, iconBg: "bg-indigo-500/20", iconColor: "text-indigo-400" },
];
    ...
    <div className="flex min-h-screen bg-slate-100">
      ...
      >
        ...
        <div className="px-4 py-5 border-b border-white/5 flex-shrink-0">
          ...
          {/* User card */}
          <div className="flex items-center gap-3 px-3 py-2.5 rounded-2xl bg-white/5 border border-white/7">
        ...
        {/* Nav links */}
        <nav className="flex-1 overflow-y-auto px-3 py-4 flex flex-col gap-0.5 scrollbar-hide">
        ...
        <div className="px-3 py-4 border-t border-white/5 flex flex-col gap-0.5 flex-shrink-0">
          ...
          <button
            onClick={logOut}
            className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-red-400/70 hover:bg-red-500/10 hover:text-red-400 transition-all duration-200 w-full group"
          >
